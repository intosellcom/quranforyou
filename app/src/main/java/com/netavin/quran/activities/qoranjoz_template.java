...
import com.netavin.quran.adapters.qoranjoz_curser;
 ...
 */
public class qoranjoz_template extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.qoranjoz_template);
        ...
        findViewById(R.id.qoranjoztemp_child1).setKeepScreenOn(screen_on);

        logo_txt= (TextView) findViewById(R.id.qoranjoztemp_title);
        lst= (ListView) findViewById(R.id.qoranjoztemp_list);
        ...
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long bb)
            {
                ...
                int sound_actived=pref.getInt("sound_code",1);
                boolean qr_isdown=pref.getBoolean("sura_"+id+"-"+sound_actived,false);
                if(qr_isdown==true)
                {
                    if(mp.isPlaying())
                    {
        ...
        id=myint.getIntExtra("id",0);//shomare joz ya id
        key=myint.getIntExtra("key",0);//1=joz   2=hezb
        onvan=myint.getStringExtra("onvan");

        final ImageView tarjome= (ImageView) findViewById(R.id.qoranjoztemp_tarjome);
        ...
        /*final ImageView sharh= (ImageView) findViewById(R.id.qoranjoztemp_sharh);
        ...
        final ImageView kuchak= (ImageView) findViewById(R.id.qoranjoztemp_kuchak);
        ...
        final ImageView bozorg= (ImageView) findViewById(R.id.qoranjoztemp_bozorg);
    ...
    public void setBoard()
    {
        if(key==1)
        {
            logo_txt.setText("جزء "+id);
        }
        else
        {
            logo_txt.setText("حزب "+id);
        }
        //logo_txt.setText("جزء "+id);
        ...
        if(key==1)
        {
            Cursor cursor=dbHelper.getQoranJozCurserTest(id);
            kol_aya=cursor.getCount();

            //cursor.getCount()=num_aye==daqiq ba besmelah
            qoranjoz_curser todoAdapter = new qoranjoz_curser(qoranjoz_template.this, cursor,cursor.getCount(),type,id);
            lst.setAdapter(todoAdapter);
        }
        else
        {
            Cursor cursor=dbHelper.getQoranHezbCurserTest(id);
            kol_aya=cursor.getCount();
    ...
    private Handler messageHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            if(msg.what==0)
            {
                lst.setAdapter(new qaran_adapter(qoranjoz_template.this, vec,type,0));
            }
            if(msg.what==1)
            {
                //
    ...
    {
        progressBar_circle = ProgressDialog.show(qoranjoz_template.this, str, "کمی صبر کنید . . .");
    ...
    {
        dialog = new Dialog(qoranjoz_template.this);
        ...
        RecyclerView.Adapter mAdapter=new font_adapter(qoranjoz_template.this,values,1030);
    ...
    public void qary_dialog()
    {
        ...
        RecyclerView.Adapter mAdapter=new font_adapter(qoranjoz_template.this,values,200);
        mRecyclerView.setAdapter(mAdapter);
    ...
    {
        progressBar_circle = ProgressDialog.show(qoranjoz_template.this, "", "کمی صبر کنید . . .");
        progressBar_circle.setCancelable(false);
    ...
    {
        final Dialog dialog_info = new Dialog(qoranjoz_template.this);
    ...
    public void showDialogDownload(final String mydb)//qoran_sharh
    {
        ...
        dialog_down = new Dialog(qoranjoz_template.this);
        ...
        bale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(qoranjoz_template.this, "برای دریافت فایل به اینترنت متصل شوید...", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    downloadTask = new DownloadTask(qoranjoz_template.this);
    ...
    public void showDialogDownloadSound()
    {
        ...
        bale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    downloadsoundtask = new DownloadSoundTask(qoranjoz_template.this);
                    bale.setEnabled(false);
                    sound_is_down=true;
    ...
    private class DownloadSoundTask extends AsyncTask<String, Integer, String>
    {
        ...
        protected String doInBackground(String... f_url)
        {
            ...
            String qoran_qary_url=pref.getString("qoran_qary_url","http://everyayah.com/data/Menshawi_16kbps/");
            ...
            else
            {
                if(id==1)
                {
                    ...
                    if(cur_aye>kol_aya)
                    {
                        sound_is_down=false;
                        dialog_down.dismiss();
                        editor.putBoolean("sura_"+id,true).commit();
                    }
                    else
                    {
                        downloadsoundtask = new DownloadSoundTask(qoranjoz_template.this);
